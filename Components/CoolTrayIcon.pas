        ...
        Application.ProcessMessages;
{
        ...
        // Hack: send messages to let popup menu close after it loses focus
        SetWindowPos((Owner as TWinControl).Handle, HWND_BOTTOM, 0, 0, 0, 0, SWP_NOMOVE or SWP_NOSIZE or SWP_NOZORDER or SWP_NOOWNERZORDER or SWP_NOSENDCHANGING or SWP_NOREDRAW);
